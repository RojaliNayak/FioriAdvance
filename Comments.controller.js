...
sap.ui.define([
	...
	return BaseController.extend("com.hd.rtvview.controller.Comments", {
		...
		onInit: function() {
			...
			this.getRouter().getRoute("comments1").attachPatternMatched(this._onObjectMatched, this);
		...
		_onObjectMatched: function(oEvent) {
			...
			this.getOwnerComponent().googleAnalyticUpdate({page:"Comments",site: sWERKS});//Google Analytics
		},
