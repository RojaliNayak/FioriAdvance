...
sap.ui.define([
	...
	return BaseController.extend("com.hd.rtvview.controller.History", {
		...
		onInit: function() {
			...
			this.getRouter().getRoute("history1").attachPatternMatched(this._onObjectMatched, this);
			this.setModel(oViewModel, "detailView");
			
			//--
			var historyModel = new JSONModel();
			historyModel.setSizeLimit(1000);
			this.getView().setModel(historyModel, "historyModel");
		},

		_onObjectMatched: function(oEvent) {
			var historyModel = this.getView().getModel("historyModel");
			historyModel.setData("");
			historyModel.checkUpdate(true);
			...
			this.getModel().metadataLoaded().then(function() {
				...
				this._bindHistoryTable(sWERKS, /*sRtvNum,*/ sLABEL_NUM);
			}.bind(this));
			this.getOwnerComponent().googleAnalyticUpdate({page:"Label History",site: sWERKS});//Google Analytics
		},
		...
		_bindHistoryTable: function(werks,labelNo){
			var oModel = this.getView().getModel();
			var sPath = "/HistorySet";
			var aFilters = [
